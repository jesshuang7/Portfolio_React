            ...
            <Header />
                <div className="intro-container container col-md-10 col-sm-10 col-xs-8 ml-4 mt-5 mb-5">
                    ...
                    <div className="card float-left mr-5" style={{width: "15rem"}}>
                        <img src="/Assets/Images/jessica.jpeg" className="card-img-top" alt="Jessica" />
                            ...
                            <div className="card-body">
                                <a href="https://www.linkedin.com/in/tzunu-jessica/" className="card-link"><img src="Assets/Images/linkedin.png" alt="linkedin-image" width="15%"/></a>
                                    <a href="https://github.com/jesshuang7" className="card-link"><img src="Assets/Images/github.png" alt="github-image" width="30%"/></a>
                                        <a href="./Assets/2020_Jessica_Software_Engineer.pdf" className="card-link">resume</a>
                            </div>
                     </div>
                                <br />
